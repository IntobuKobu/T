...
TryLag = 0
	...
	RL.wrapAttackAnimationAsync = function(a,b,c,d,func)
		if not _G.FastZure then
			PC.play = shared.cpc
			return shared.orl(a,b,c,65,func)
		end
		local Radius = (_G.FastZure and _G.FastZureRadius) or 65
...
task.spawn(function()
    ...
    repeat
        for _,v in pairs(workspace.Enemies:GetChildren()) do
            if v and v.Name == NameMon and v:FindFirstChild("Humanoid") and v.Humanoid.Health ~= 0 then
